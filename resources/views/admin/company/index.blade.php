  ...
  <body>
    <div class="admin__panel-container">
      ...
      <div class="dashboard">
        <header class="dashboard__navbar">
          <h2 class="dashboard__navbar-title">Company</h2>
          <input
          ...
          <div class="dashboard__main-product-container">
            <div class="dashboard__so">
              ...
              <div class="dashboard__so-btn-container">
                ...
                <div class="dashboard__card" style="padding: 0px; margin-left: 1rem;">
    ...
    <div class="dashboard__sr-modal js-modal" data-id="modal">
      ...
      @csrf
        ...
        <div class="dashboard__sr-modal-save" style="bottom: 0px; position: absolute; width: 100%; left: 0;">
    ...
    <div class="sr__profile js-profile-modal">
      ...
      <form style="padding: 2rem" class="sr__update" action="" method="post" enctype="multipart/form-data">
      @csrf
        <div class="dashboard__sr-modal-row">
          <div>
            <label>Logo</label>
        ...
        <div class="dashboard__sr-modal-row">
          <div>
            <label for="">Name <sapn class="red-mark">*</sapn></label>
            <input type="text" name="name" class="sr__name" placeholder="Muhammad Rasel" />
          </div>
          <div>
            <label for="email">Email <sapn class="red-mark">*</sapn></label>
            <input type="email" name="email" class="sr__email" placeholder="admin@gmail.com" />
          </div>
        </div>
        <div class="dashboard__sr-modal-save" style="bottom: 0px; position: absolute; width: 100%; left: 0;">
          <button class="js-close-btn">Cancel</button>
