...
<head>
  ...
  <link
    ...
    rel="stylesheet" />
  <link rel="stylesheet" href="{{ asset('admin/delivery_add/css/style.css') }}" />
...
<body>
  <div class="addNewDealer-container">
    <div class="addNewDealer">
      <div class="addNewDealer__navbar">
        <h2 class="addNewDealer__navbar-title">Add New Delivery man</h2>
      ...
      <div class="addNewDealer__profile__pic">
        <h2 class="addNewDealer__profile__pic-title">Shop Image</h2>
  ...
  <script src="{{ asset('admin/delivery_add/js/index.js') }}"></script>
</body>
