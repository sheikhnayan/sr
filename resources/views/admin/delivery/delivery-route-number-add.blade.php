...
<head>
  ...
  <link
    ...
    rel="stylesheet" />
  <link rel="stylesheet" href="{{ asset('admin/delivery_route_number_add/css/style.css') }}" />
...
<body>
  <div class="addNewDealer-container">
    <div class="addNewDealer">
      <div class="addNewDealer__navbar">
        <h2 class="addNewDealer__navbar-title">Add New Route</h2>
      ...
      <div class="addNew__route">
        <p class="addNew__route-title">Number</p>
        <input class="addNew__route-field" type="text" placeholder="+88025 6988 0995">
      </div>
      <div class="addNew__route">
        <p class="addNew__route-title">Select Day</p>
        <input class="addNew__route-field" type="text" placeholder="Today">
      </div>
      <div class="addNew__route">
        <p class="addNew__route-title">Select Union</p>
        <input class="addNew__route-field" type="text" placeholder="Union Name">
      </div>
      <div class="addNew__route">
        <p class="addNew__route-title">Select Bazar</p>
        <input class="addNew__route-field" type="text" placeholder="Bazar Name">
      </div>
  ...
  <script src="{{ asset('admin/delivery_route_number_add/js/index.js') }}"></script>
</body>
