...
<head>
  ...
  <link
    ...
    rel="stylesheet" />
  <link rel="stylesheet" href="{{ asset('admin/dealer_list/css/style.css') }}" />
...
<body>
            ...
            <div class="dashboard__top-ten">
              <div class="tabs dashboard__top-tabs">
                <div class="tabs-nav-wrapper">
                  <div>
                    <h2 class="tabs-nav-title">All SR</h2>
                  </div>
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><button class="view__product-btn">View Product</button></td>
                        </tr>
                        <tr>
                          <td>1</td>
                          <td class="sr-name">
  ...
  <script src="{{ asset('admin/dealer_list/js/index.js') }}"></script>
</body>
